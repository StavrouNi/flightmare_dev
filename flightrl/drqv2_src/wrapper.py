...
class FlightmareDrQWrapper(gym.Env):
    def __init__(self, cfg, stack_frames=3):
        ...
        # We ignore the 'cfg' passed in for this part because it's the wrong file
        ...
        # ... (Rest of __init__ is the same: spaces, buffer, logic vars) ...
    ...
    def reset(self):
            ...
            for attempt in range(max_retries):
                try:
                    ...
                    # print(f"  [Wrapper] Retry {attempt+1}: Stepping sim to wake up Unity...")
    ...
    def step(self, action):
        ...
        # 3. Update Visuals
        # print(f"[Wrapper]  Getting image observation...")
        img = self._get_image_obs()
        self.frame_buffer.append(img)
        
        # 4. Check Crash (Floor/Ceiling/Bounds)
        done = False
